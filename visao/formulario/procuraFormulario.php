...
<html>
    ...
    <body onload="HoraAtual();">
        <div id="conteudo">
            ...
            ?>
            <form action="" name="fprocuraFormulario" method="post">
                <fieldset>
                    <p>
                        <label>Nome:</label>
                        <input type="text" name="nome" size="50" maxlength="50" placeholder="Digite o nome aqui para pesquisar, deixe em branco e volta todos"/>
                    </p>
                    <p>
            ...
            <div id="resultado">
                ...
                <?
                    ...
                    if($submited != NULL && $submited == "true"){
                        require_once "../../controle/formulario/procuraFormulario.php";
                    }
                ?>        
            </div>
        </div>
