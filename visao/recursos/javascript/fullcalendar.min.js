...
(function(m,ma){
    function wb(a){
        ...
        if(j()){
            ...
            k=new Date;
            k>=n.start&&k<n.end?C.disableButton("hoje"):C.enableButton("hoje");
            F--;
...
function Ta(){
    ...
    function d(w,I,R,V){
        ...
        E.each(function(wa,Ga){
            ...
            +aa==+V?ea.addClass(la+"-state-highlight fc-hoje"):ea.removeClass(la+"-state-highlight fc-hoje");
...
function qc(a,b){
    ...
    function d(h){
        ...
        for(h=0;h<Ba;h++){
            ...
            O.html(s(A,Vb));
            x=M.eq(h);
            +A==+ta?x.addClass(Wa+"-state-highlight fc-hoje"):x.removeClass(Wa+"-state-highlight fc-hoje");
            rb(O.add(x),A)
            }
        }
        function j(h,O){
    ...
    if(vb=w.width()-h){
        Va(va,vb);
        va.show().anterior().removeClass("fc-last")
        }else va.hide().anterior().addClass("fc-last");
...
var Ya={
    ...
    theme:false,
    buttonIcons:{
        anterior:"circle-triangle-w",
        próximo:"circle-triangle-e"
    },
    unselectAuto:true,
    dropAccept:"*"
},yc=
{
    ...
    buttonIcons:{
        anterior:"circle-triangle-e",
        próximo:"circle-triangle-w"
    }
},Aa=m.fullCalendar={
    version:"1.5.4"
},Ja=Aa.views={};
